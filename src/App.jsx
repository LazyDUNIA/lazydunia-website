      ...
      <div className="bg-slate-50 font-sans text-slate-800 min-h-screen flex flex-col antialiased max-w-full overflow-x-hidden">
        ...
        <nav className="sticky top-0 z-50 backdrop-blur-xl bg-white/70 supports-[backdrop-filter]:bg-white/60 border-b border-white/20">
          <div className="relative">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center h-20 relative"> {/* Remove justify-between here */}
              ...
              {/* Brand / Title */}
          <div className="flex-grow md:flex-none flex justify-center md:justify-start">
  <h1 className="cursor-pointer md:ml-[75px]">
    <img
      src="./LazyDUNIA-logo.svg"
      alt="Lazy Dunia Logo"
      className="block w-[125px] h-[70px]"
    />
  </h1>
</div>
              ...
              {/* Desktop nav */}
              <div className="hidden md:flex items-center gap-10 md:ml-auto"> {/* Added md:ml-auto */}
